...
public class BattleManagerScript : MonoBehaviour
{
    ...
    public void StartNewBattle(Battler _battler)
    {
        battleScene.SetActive(true);
        SetOpponentDeck(_battler.deck);
        opponentCardBack = _battler.cardBack;
        CreateHand(1);
        ...
        opponentHealth = _battler.health;
